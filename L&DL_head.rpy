init -990 python:
    store.mas_submod_utils.Submod(
        ...
        description="A submod that includes a large number of topics, several songs, etc.",
        version='0.5.0',
...
define LADL_authors = """\
度海、moon、456、Kxiangtang、哞尼卡、群阿巴阿巴、君翌、俩fish、龟酱. and Stary
"""

define LADL_thanks = """\
特别感谢以下人员：
- Main Devs:白莫, 庭有枇杷树
- Artist Team:最初の心, 璀辰, Sir.P
- Translating Team: Stary
"""
